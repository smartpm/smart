...
class GtkInteractiveInterface(GtkInterface):
    ...
    def upgradeAll(self):
	#first I ask the user if he wants to update the channel information before updating
	if self.askYesNo(_("You are updating the entire system.\n"
			   "Is recommended that the channels informations are updated.\n"
			   "Do you want to update automatically now?"), True):
	    self.updateChannels()
